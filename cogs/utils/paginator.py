...
class Pages:
    ...
    def __init__(self, ctx, *, entries, per_page=12, show_entry_count=True, title=None):
        ...
        self.embed = discord.Embed(colour=discord.Color(0x36393E))
...
class HelpPaginator(Pages):
    ...
    def prepare_embed(self, entries, page, *, first=False):
        ...
        if self.get_page is self.get_bot_page:
            value ='For more help, join the official bot support server: https://discord.gg/cju9v3W'
...
class PaginatedHelpCommand(commands.HelpCommand):
    ...
    async def send_bot_help(self, mapping):
        ...
        entries = await self.filter_commands(bot.walk_commands(), sort=True, key=key)
        nested_pages = []
        per_page = 9
        total = 0
    ...
    async def send_command_help(self, command):
        ...
        embed = discord.Embed(colour=discord.Color(0x36393E))
